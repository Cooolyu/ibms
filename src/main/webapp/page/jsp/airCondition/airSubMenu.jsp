...
<!-- 				<div style="margin-left:15px; margin-top: 20px;">
				...
				<div >
					<a class="com-tab com-tab-default com-tab-sm " style="margin-left:25px; font-size: 15px;font-family:微软雅黑;">暖通空调</a>
					<a class="com-tab com-tab-default com-tab-sm " style="margin-left:25px; font-size: 15px;font-family:微软雅黑;" >给排水</a>
					<a class="com-tab com-tab-default com-tab-sm " style="margin-left:25px; font-size: 15px;font-family:微软雅黑;" >供配电</a>
				</div>
			</div>
		</div>
	</div>