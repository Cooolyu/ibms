...
<link rel="stylesheet" type="text/css" href="<%=request.getContextPath()%>/page/css/main.css"/>
<link href="<%=request.getContextPath()%>/page/thirdparty/font-awesome/css/font-awesome.min.css" rel="stylesheet" type="text/css"></link>
...
<jsp:include page="/page/jsp/widget/daterange.jsp"></jsp:include>
 <!--[if lt IE 9]>
